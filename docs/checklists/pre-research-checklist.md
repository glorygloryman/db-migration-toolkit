...
- [ ] 自增 / 序列使用情况评估完成
- [ ] 隐式类型转换点评估完成
- [ ] 代码引用的数据库、表、字段已与真实 MySQL schema 对齐检查
- [ ] 缺失数据库、表、字段已记录为 blocker，未通过临时对象绕过
...
- [ ] "关键路径"清单已圈定
- [ ] 测试缺口按优先级排序
- [ ] 已扫描测试代码、`@Sql`、`@BeforeAll`、测试 support helper 中的数据库对象 DDL
- [ ] 不存在将自行创建数据库对象的测试计为真实 schema 集成测试覆盖
